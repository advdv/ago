...
8. Make sure to add the following to the cdk's .gitignore:
    - "cdk" so the cdk binary doesn't get committed when compiled.
9. Clean up the CDK project by removing:
    - the _test file that was created as part of the setup
    - the README.md that was created as part of the setup
10. Use the "setting-up-cdk-app" skill to replace the boilerpalte CDK code. 
